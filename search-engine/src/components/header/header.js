...
const Header = ({isAuthenticated, setIsAuthenticated, user}) => {
    ...
    return(
        <header>
            ...
            {isAuthenticated ?
             <> 
                    <NavLink className="header-list" to="/search-bar"><li className="header-list-li">Search</li></NavLink>
                    <NavLink className="header-list" to="/home-page" onClick={signOut}><span className="login-logout">Logout</span></NavLink> 
             </> 
            : 
                    <NavLink className="header-list" to="/login-register"><span className="login-logout">Login/Register</span></NavLink>}
        </header>
